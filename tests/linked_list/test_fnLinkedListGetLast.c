...
void test_fnLinkedListGetLast() {
  ...
  *piData4 = 4;
  ...
  fnLinkedListAppendNode(&pstHead, piData4);
	...
	// test
	assert(fnLinkedListGetLast(&pstHead)->pData == piData4);
  ...
  printf("test_fnLinkedListGetLast passed\n");
}

int main() {
  printf("Running test_fnLinkedListGetLast...\n");
  test_fnLinkedListGetLast();
  printf("test_fnLinkedListGetLast passed successfully!\n");
  return 0;
}
